...
function Help() {
  return (
    <div className="flex flex-col  w-full px-10 py-10 mt-10">
      ...
      <div className="flex flex-col md:flex-row mt-10 gap-14">
        <div className="h-[30vh] md:h-[400px] md:w-[550px] overflow-hidden rounded-xl bg-gray-00">
          <img
        ...
        <div className="md:w-[40%] flex flex-col gap-3 items-start justify-center">
